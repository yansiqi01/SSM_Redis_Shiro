...
*/(function (d, p, q, u) {
	...
	methods = {
		...
		open: function (a, b) {
			...
			0 != a.closeHide && (closeBtnTpl = '<a id="HCloseBtn" title="\u5173\u95ed" style="width:24px;height:24px;line-height:24px;display:inline-block;cursor:pointer;color:#fff;font-size:24px;text-align:center;position:absolute;top:36px;right:40px;"><span style="width:24px;height:24px;display:inline-block;">\u00d7</span></a>');
